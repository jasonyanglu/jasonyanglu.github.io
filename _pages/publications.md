...
- [<span style="color:blue">**CVPR**</span>] Long-tailed Visual Recognition via Gaussian Clouded Logit Adjustment  
  ...
  IEEE/CVF Conference on Computer Vision and Pattern Recognition, 2022, accepted. (CCF A)
- [<span style="color:blue">**ICASSP**</span>] Bounding Box Distribution Learning and Center Point Calibration for Robust Visual Tracking  
...
- [<span style="color:blue">**ICASSP**</span>] Multi-Focus Guided Semantic Aggregation for Video Object Detection  
  ...
  _IEEE International Conference on Acoustics, Speech and Signal Processing_, 2022, accepted. (CCF B)
- [<span style="color:blue">**ACMMM**</span>] Towards a Unified Middle Modality Learning for Visible-Infrared Person Re-Identification  
...
- [<span style="color:blue">**MMAsia**</span>] Global and Local Feature Alignment for Video Object Detection  
...
- [<span style="color:blue">**WCICA**</span>] GOBoost: G-mean Optimized Boosting Framework for Class Imbalance Learning  
  **Yang Lu**, Yiu-ming Cheung, and Yuan Yan Tang  
...
- [<span style="color:blue">**ICMLC**</span>] Learning Performance of DAGSVM Algorithm Based on Markov Sampling  
...
- [<span style="color:blue">**CYBCONF**</span>] Sparse Representation Using Contextual Information for Hyperspectral Image Classification  
...
- [<span style="color:blue">**CYBCONF**</span>] Spectral-Spatial Linear Discriminate Analysis for Hyperspectral Image Classification  
  Haoliang Yuan, **Yang Lu**, Lina Yang, Huiwu Luo, and Yuan Yan Tang  
